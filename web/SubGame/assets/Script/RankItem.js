cc.Class({
    ...
    init: function (rank, data,isPlayer) {
        ...
        if (isPlayer) {
            this.rankLabel.node.color = new cc.Color(248,217,70);
            this.topScoreLabel.node.color = new cc.Color(248,217,70);
            this.nickLabel.node.color = new cc.Color(248,217,70);
        }
        // if (rank % 2 == 0) {
